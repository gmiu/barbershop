...
def index():
    if current_user.username == 'admin':
        ...
        today_reservations = current_user.get_reservations_for_date(date.today()).filter_by(confirmed_status=True)
        return render_template('barber/index.html', today_reservations=today_reservations)
